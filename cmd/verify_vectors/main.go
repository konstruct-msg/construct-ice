// verify_vectors — confirms construct-veil Elligator2/DH test vectors match
...
func main() {
	peer := h32(peerHex)
	failures := 0
	fmt.Println("=== Verifying construct-veil test vectors against Go x25519ell2 (tweak=0) ===")
	fmt.Println()
